...
CREATE SEQUENCE SEQUENCE_CONTEST_SEQ INCREMENT BY 1 START WITH 1000000;

revoke all on "informix".SEQUENCE_CONTEST_SEQ from "public";

grant select on "informix".SEQUENCE_CONTEST_SEQ to "public" as "informix";
...
create view 'informix'.active_data_science_challenges (challenge_type, challenge_name, challenge_id, num_submissions,
...
SELECT
    ...
    , NVL(pp1.actual_start_time, pp1.scheduled_start_time)::datetime year to second AS registration_start_date
    , NVL(pp2.actual_end_time, pp2.scheduled_end_time)::datetime year to second AS submission_end_date
    , 'Develop'::nvarchar(50) as challenge_community
    , NVL(pp1.actual_start_time, pp1.scheduled_start_time)::datetime year to second AS posting_date
...
grant select on active_data_science_challenges to 'informix' with grant option;
...
create view 'informix'.upcoming_data_science_challenges (challenge_type, challenge_name, challenge_id, num_submissions,
                                                     num_registrants, registration_start_date, submission_end_date,
                                                     challenge_community, posting_date) as
    -- Data Science projects
SELECT
...
grant select on upcoming_data_science_challenges to 'coder' as 'informix';
grant select on upcoming_data_science_challenges to 'informix' with grant option;
