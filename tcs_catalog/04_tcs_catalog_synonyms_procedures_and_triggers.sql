...
p_project_phase_id int,
p_old_scheduled_start_time datetime year to fraction,
p_new_scheduled_start_time datetime year to fraction,
...
grant execute on procedure update_autopilot_phase_change_event(
int,
datetime year to fraction,
datetime year to fraction,
datetime year to fraction,
...
create trigger "informix".trig_project_phase_delete_autopilot delete on "informix".project_phase referencing old as old for each row
        (
        execute procedure "informix".delete_autopilot_phase_change_event(old.project_phase_id));
