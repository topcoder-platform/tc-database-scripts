...
SELECT 768, p.project_id, current
FROM project p
INNER JOIN project_phase pp ON p.project_id = pp.project_id and pp.phase_type_id = 1 and
                               pp.actual_start_time >= '2022-07-01 00:00:00.000' and pp.actual_start_time <  '2023-04-01 00:00:00.000'
...
-- Overall - yearlong
insert into contest_project_xref
SELECT 774, p.project_id, current
FROM project p
INNER JOIN project_phase pp ON p.project_id = pp.project_id and pp.phase_type_id = 1 and
                               pp.actual_start_time >= '2022-07-01 00:00:00.000' and pp.actual_start_time <  '2023-04-01 00:00:00.000'
INNER JOIN project_info pi12 ON p.project_id = pi12.project_id and pi12.project_info_type_id = 12 and pi12.value = 'Yes'
...
-- Overall - yearlong
insert into contest_project_xref
SELECT 775, p.project_id, current
FROM project p
INNER JOIN project_phase pp ON p.project_id = pp.project_id and pp.phase_type_id = 1 and
                               pp.actual_start_time >= '2022-07-01 00:00:00.000' and pp.actual_start_time <  '2023-04-01 00:00:00.000'
INNER JOIN project_info pi12 ON p.project_id = pi12.project_id and pi12.project_info_type_id = 12 and pi12.value = 'Yes'
...
-- Overall - yearlong
insert into contest_project_xref
SELECT 783, p.project_id, current
FROM project p
INNER JOIN project_phase pp ON p.project_id = pp.project_id and pp.phase_type_id = 1 and
                               pp.actual_start_time >= '2022-07-01 00:00:00.000' and pp.actual_start_time <  '2023-04-01 00:00:00.000'
INNER JOIN project_info pi12 ON p.project_id = pi12.project_id and pi12.project_info_type_id = 12 and pi12.value = 'Yes'
...
-- TDDO: include DS ideation challenges

--Overall - yearlong

insert into contest_project_xref
SELECT 787, p.project_id, current
FROM project p
INNER JOIN project_phase pp ON p.project_id = pp.project_id and pp.phase_type_id = 1 and
                               pp.actual_start_time >= '2022-07-01 00:00:00.000' and pp.actual_start_time <  '2023-04-01 00:00:00.000'
INNER JOIN project_info pi12 ON p.project_id = pi12.project_id and pi12.project_info_type_id = 12 and pi12.value = 'Yes'
