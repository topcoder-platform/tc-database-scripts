...
insert into 'informix'.project values (1, 1, 'Test Project 1', 1, 0, 'TESTPROJECT-01', 1, 'description', current, mdy(1,1,2011), 1, 1, null, 0,current, 'admin', current, 'admin', 0, 5000);
insert into 'informix'.project values (2, 1, 'Test Project 2', 1, 0, 'TESTPROJECT-02', 1, 'description', current, mdy(1,1,2011), 1, 1, null, 0, current, 'admin', current, 'admin', 0, 5000);
insert into 'informix'.project values (3, 1, 'Test Project 3', 1, 0, 'TESTPROJECT-03', 1, 'description', current, mdy(1,1,2011), 1, 1, null, 0, current, 'admin', current, 'admin', 1,  5000);

insert into 'informix'.project_worker values (1, 1, current, mdy(1,1,2011), 0, 0, 1, current, 'admin', current, 'admin');
insert into 'informix'.project_worker values (1, 2, current, mdy(1,1,2011), 0, 0, 1, current, 'admin', current, 'admin');
insert into 'informix'.project_worker values (1, 3, current, mdy(1,1,2011), 0, 0, 1, current, 'admin', current, 'admin');
insert into 'informix'.project_worker values (2, 1, current, mdy(1,1,2011), 0, 0, 1, current, 'admin', current, 'admin');
insert into 'informix'.project_worker values (3, 1, current, mdy(1,1,2011), 0, 0, 1, current, 'admin', current, 'admin');
insert into 'informix'.project_worker values (3, 2, current, mdy(1,1,2011), 0, 0, 1, current, 'admin', current, 'admin');
...
insert into  project values (70015983, 1, 'Liquid Community', 1, '0.00', 'Liquid PO 1', 1, 'description', '2010-03-20 15:52:10', '2011-01-01 00:00:00', 1, 70014096, null, 0, current, 'admin' , current, 'adming', 0, 5000);

insert into  project values (70015984, 1, 'Liquid (CA)', 1, '0.00', 'Liquid PO 1', 1, 'description', '2010-03-20 15:52:10', '2011-01-01 00:00:00', 1, 70014096, null, 0, current, 'admin' , current, 'adming', 0, 5000);
...
insert into 'informix'.project_worker values (70015984, 2, current, mdy(1,1,2011), 0, 0, 1, current, 'admin', current, 'admin');
insert into 'informix'.project_worker values (70015983, 2, current, mdy(1,1,2011), 0, 0, 1, current, 'admin', current, 'admin');
